...
class NativeAdWidget1 extends StatefulWidget {
  const NativeAdWidget1({super.key});

  @override
  State<NativeAdWidget1> createState() => _NativeAdWidget1State();
}

class _NativeAdWidget1State extends State<NativeAdWidget1> {
  NativeAd? _nativeAd;
  bool _loaded = false;
